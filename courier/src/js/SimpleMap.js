/* global google, define */
	...
	var mapOptions = {
		...
		markers:     [
			{
				locationlatlng: '12.8949812,77.6161421',
				title:          'demo marker',
				custompinimage: '',
			}
		],
	...
	SimpleMap.prototype.renderMap = function() {
		...
		if (typeof route !== typeof undefined && route !== false) {
			...
			var start = new google.maps.LatLng(12.8946617, 77.6135156);
			var end = new google.maps.LatLng(12.8946617, 77.6135156);
